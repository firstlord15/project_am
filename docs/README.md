...
- Второй модуль для регистрации, авторизации и информацию о себе

Документация по модулю бухгалтерского учёта: [`docs/finance-service.md`](/docs/finance-service.md).
## Table of Contents
...
- Аутентификация и авторизация — JWT token собственная реализация (HS256, общий секретный ключ между сервисами).
